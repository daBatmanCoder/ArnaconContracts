...
contract MerkleTreeWithHistory {
    ...
    uint256 public constant FIELD_SIZE =
        1888242871839275222246405745257275088548364400416034343698204186575808495617;

    uint256 public constant ZERO_VALUE =
        13463839004416992837492374982374927345266501822907911457504978515578255421292; // = keccak256("cellact") % FIELD_SIZE
    ...
    */
    ...
    function hashSingleElement(uint256 element) public view returns (uint256) {
        (uint256 xL, ) = hasher.MiMCSponge(element, 0, 0);
        return xL;
    }
